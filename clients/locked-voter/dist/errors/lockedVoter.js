...
export function getLockedVoterErrorMessage(code) {
    if (process.env.NODE_ENV !== "production") {
        return lockedVoterErrorMessages[code];
    }
    return "Error message not available in production bundles.";
}
export function isLockedVoterError(error, transactionMessage, code) {
    return isProgramError(error, transactionMessage, LOCKED_VOTER_PROGRAM_ADDRESS, code);
}
